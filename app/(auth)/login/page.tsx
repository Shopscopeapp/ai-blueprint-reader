...
import { Loader2, Grid3x3, Lock, Mail, ArrowRight, Sparkles } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e27] relative overflow-hidden flex items-center justify-center px-4">
      {/* Animated Background */}
          ...
          <div className="flex justify-between items-center h-20">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-xs text-cyan-400/60 font-mono">SYSTEM ACCESS</div>
              </div>
            </Link>
            <Link
              href="/register"
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-xl mb-4 shadow-lg shadow-cyan-400/50">
                <Lock className="w-10 h-10 text-[#0a0e27]" />
              </div>
